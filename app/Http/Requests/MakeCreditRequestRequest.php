...
class MakeCreditRequestRequest extends FormRequest
{
    ...
    {
        return [
            "money" => ["required", "decimal:0,10", "min:1"],
    ...
    public function messages(): array {
        return [
            "money.required" => "Vous devez entrer une somme pour le prêt",
            "money.decimal" => "Le montant du prêt doit être un nombre à virgule",
            "money.min" => "Le montant du prêt doit être supérieur à 0",
